...
<div class="container">
    <header>
        <a href=""><h1>Название сайта</h1></a>
        <div class="nav">
            <a href="#">Руководство по использованию</a><a href="">Контакты</a><a href="">Поиск по базе</a><a href="">Источники</a><a href="">Импорт новых товаров</a><a href="{{ route('login') }}">Личный кабинет</a>
        </div>
    </header>
</div>
...
<footer>
    <div class="container">
        <div class="footer__column">
            <a href="/"><h2>{{ config('app.name') }}</h2></a>
        </div>
        <div class="footer__column">
