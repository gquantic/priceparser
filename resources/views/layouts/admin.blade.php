...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{asset('plugins/icheck-bplugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.cssootstrap/icheck-bootstrap.min.css')}}">
    <!-- JQVMap -->
                        ...
                        <div class="media">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    <i class="fas fa-sign-out-alt" style="margin-right: 10px"></i> Выйти
                                </h3>
                            </div>
                        </div>
                    </a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <i class="fas fa-user-circle" style="font-size: 34px; color: #c2c7d0"></i>
                </div>
                <div class="info">
                    <a href="{{ route('my.balance.show') }}" class="d-block">{{auth()->user()->name}}</a>
            ...
            <!--<div class="form-inline">
                <div class="input-group" data-widget="sidebar-search">
                    <input class="form-control form-control-sidebar" type="search" placeholder="Поиск по товарам" aria-label="Search">
                    <div class="input-group-append">
